...
import { Check, ArrowRight, Shield, Users, Building2, Mail, HelpCircle } from "lucide-react";
...
const FeatureItem = ({ feature, hasTooltip, tooltipText }: { feature: string; hasTooltip?: boolean; tooltipText?: string }) => (
...
export const PricingCalculator = () => {
  ...
  const displayPrice = billingPeriod === "monthly" ? monthlyPrice : annualMonthlyPrice;
  ...
  const smallDisplayPrice = billingPeriod === "monthly" ? smallPlanMonthly : smallPlanAnnual;
        ...
        <Card className="border border-border/60 bg-card relative flex flex-col md:transition-all md:duration-300 md:hover:shadow-lg md:hover:-translate-y-1">
          <CardContent className="p-3 sm:p-4 lg:p-6 flex flex-col flex-1">
            ...
            <div className="text-center mb-2 sm:mb-4">
              ...
              <h3 className="text-base sm:text-lg font-semibold text-foreground mb-0.5 sm:mb-1">Pequeña empresa</h3>
              <p className="text-xs sm:text-sm text-muted-foreground">Hasta 3 empleados</p>
            </div>
            ...
            <div className="text-center mb-3 sm:mb-4">
              <div className="flex items-baseline justify-center gap-1">
                ...
                <span className="text-lg sm:text-xl font-bold text-foreground">&euro;</span>
              ...
              {billingPeriod === "annual" ? (
                <div className="mt-1 space-y-0.5">
                  <p className="text-xs text-muted-foreground line-through">
                    {formatPrice(smallPlanMonthly, 0)}&euro;/mes
                  </p>
                  <p className="text-xs font-semibold text-green-600 dark:text-green-400">
                    Ahorras {formatPrice(smallPlanSavings, 0)}&euro;/año
                  </p>
                </div>
              ) : (
            ...
            {/* Button */}
            <a href="https://app.fichados.es/registro-empresa" className="block mb-2 sm:mb-4">
              <Button className="w-full h-10 sm:h-12 text-sm sm:text-base" variant="outline">
                Cumple la ley hoy
              </Button>
            </a>
        ...
        <Card className="border border-border/60 bg-card relative flex flex-col md:transition-all md:duration-300 md:hover:shadow-lg md:hover:-translate-y-1">
          <CardContent className="p-3 sm:p-4 lg:p-6 flex flex-col flex-1">
            ...
            <div className="text-center mb-2 sm:mb-4">
              ...
              <h3 className="text-base sm:text-lg font-semibold text-foreground mb-0.5 sm:mb-1">Mediana empresa</h3>
              <p className="text-xs sm:text-sm text-muted-foreground">De 4 a 50 empleados</p>
            </div>
            ...
            <div className="h-8 sm:h-10 mb-2">
              ...
              <Slider
                value={[employees]}
                onValueChange={(value) => setEmployees(Array.isArray(value) ? value[0] : value)}
                min={4}
                max={50}
                step={1}
                className="w-full"
            ...
            <div className="text-center mb-3 sm:mb-4">
              ...
              {billingPeriod === "annual" ? (
                <div className="mt-1 space-y-0.5">
                  <p className="text-xs text-muted-foreground line-through">
                    {formatPrice(monthlyPrice, 0)}&euro;/mes
                  </p>
                  <p className="text-xs font-semibold text-green-600 dark:text-green-400">
                    Ahorras {formatPrice(annualSavings, 0)}&euro;/año
                  </p>
                </div>
              ) : (
                <div className="mt-1 h-8" />
            ...
            {/* Button */}
            <a href="https://app.fichados.es/registro-empresa" className="block mb-2 sm:mb-4">
              <Button size="lg" className="w-full h-10 sm:h-12 font-semibold text-sm sm:text-base">
                Cumple la ley hoy
              </Button>
            </a>
        ...
        <Card className="border border-border/60 bg-card relative flex flex-col md:transition-all md:duration-300 md:hover:shadow-lg md:hover:-translate-y-1">
          <CardContent className="p-3 sm:p-4 lg:p-6 flex flex-col flex-1">
            ...
            <div className="text-center mb-2 sm:mb-4">
              ...
              <h3 className="text-base sm:text-lg font-semibold text-foreground mb-0.5 sm:mb-1">Gran empresa</h3>
              <p className="text-xs sm:text-sm text-muted-foreground">Más de 50 empleados</p>
            </div>
            ...
            {/* Button */}
            <a href="mailto:info@fichados.es" className="block mb-2 sm:mb-4">
              <Button className="w-full h-10 sm:h-12 text-sm sm:text-base" variant="outline">
                Contactar
              </Button>
            </a>
