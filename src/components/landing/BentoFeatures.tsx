...
const VIDEO_URLS = {
  fichaje: "https://gudtttoksedpkaxwdurp.supabase.co/storage/v1/object/public/videos/bento-fichaje-v2.mp4",
  panel: "https://gudtttoksedpkaxwdurp.supabase.co/storage/v1/object/public/videos/bento-panel-admin-v2.mp4",
  ausencias: "https://gudtttoksedpkaxwdurp.supabase.co/storage/v1/object/public/videos/bento-ausencias.mp4",
  informes: "https://gudtttoksedpkaxwdurp.supabase.co/storage/v1/object/public/videos/bento-informes-v2.mp4",
} as const;
...
const tabs = [
  {
    ...
    description: "Entrada, salida y pausas en segundos desde cualquier dispositivo.",
  },
  {
    id: "panel" as const,
    icon: LayoutDashboard,
    title: "Panel de administrador",
    description: "Visión global del equipo: horas, incidencias y estado en tiempo real.",
  },
  {
    id: "ausencias" as const,
    icon: CalendarOff,
    title: "Ausencias y vacaciones",
    description: "Vacaciones, bajas y permisos centralizados y actualizados.",
  },
  {
    id: "informes" as const,
    icon: FileText,
    title: "Informes para inspección",
    description: "Exporta registros oficiales en PDF y Excel en segundos, listos para presentar ante una inspección.",
  },
];
...
function MobileCard({ tab }: { tab: (typeof tabs)[number] }) {
  ...
  return (
    ...
    >
      <div className="overflow-hidden relative" style={{ backgroundColor: "#fafafa" }}>
        {!loaded && (
      ...
      <div className="p-4 flex items-start gap-3">
        ...
        <div>
          <h3 className="font-semibold text-foreground text-sm">{tab.title}</h3>
