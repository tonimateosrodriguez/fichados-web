        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-muted-foreground">
              ...
              <li><a href="/#riesgos" className="hover:text-foreground transition-colors">Riesgos</a></li>
              <li><a href="/#como-funciona" className="hover:text-foreground transition-colors">Cómo funciona</a></li>
              <li><a href="/#como-empezar" className="hover:text-foreground transition-colors">Cómo empezar</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-muted-foreground">
              ...
              <li><Link href="/declaracion-cumplimiento" className="hover:text-foreground transition-colors">Declaración de cumplimiento legal</Link></li>
