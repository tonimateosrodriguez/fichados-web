...
export const metadata: Metadata = {
  ...
  description: "Declaración de cumplimiento legal de Fichados - Groove Factory Studios S.L. Información sobre la adecuación del servicio a la normativa laboral vigente.",
};

export default function DeclaracionCumplimiento() {
  return (
    <LegalPageLayout title="Declaración de Cumplimiento Legal">
      <section>
