...
export const metadata: Metadata = {
  ...
  description: "Cumplimiento RGPD de Fichados - Groove Factory Studios S.L. Información sobre el cumplimiento del Reglamento General de Protección de Datos.",
};

export default function CumplimientoRGPD() {
  return (
    <LegalPageLayout title="Cumplimiento RGPD">
      <section>
