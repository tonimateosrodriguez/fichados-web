        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-6 sm:space-y-8 text-center lg:text-left">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground max-w-xl">
              El sistema de fichaje online obligatorio en España. Evita
              sanciones de hasta 187.515 €
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center lg:items-start justify-center lg:justify-start gap-4 pt-4">
              <div className="flex items-center -space-x-3">
                ...
                />
                <Image
                  src="/images/testimonial-sergio.jpg"
                  alt="Empresario"
                  width={40}
                  height={40}
                  className="rounded-full border-2 border-background object-cover"
          ...
          <div id="demo-video" className="relative">
            <div
              className="rounded-2xl overflow-hidden border border-border/50 shadow-lg relative aspect-video"
